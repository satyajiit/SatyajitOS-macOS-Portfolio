...
export const pwaCopy = {
  ...
  messages: [
    `🚀 Ready to take ${site.osName} for a spin?`,
    '💫 Transform your device into a productivity powerhouse!',
    '🎯 Install now and join the elite Human.exe users!',
    '⚡ Warning: May cause excessive productivity and startup FOMO',
    `🔥 Get the full ${site.osName} experience on your home screen!`,
    '🎨 Your device deserves this level of awesomeness',
    '💎 Upgrade your digital life with one click!',
  ],
  perks: ['Works offline', 'Fast loading', 'Home screen'],
  installed: { title: 'Installed ✓', body: `${site.osName} now lives next to your real apps.` },
  update: {
